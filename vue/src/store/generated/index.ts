...
import DecspeedHelloDecspeedHelloHello from './decspeed/hello/decspeed.hello.hello'
...
export default { 
  ...
  DecspeedHelloDecspeedHelloHello: load(DecspeedHelloDecspeedHelloHello, 'decspeed.hello.hello'),
